...
public class BootProj03RealtimedependencyApplication {

	public static void main(String[] args) {
		ApplicationContext factory=SpringApplication.run(BootProj03RealtimedependencyApplication.class, args);
		 
		 IEmployeeController controller=factory.getBean(EmployeeControllerImpl.class);
